...
$archive = Join-Path $workspace 'dist\AgentWorkbench-Windows-portable-0.2.4.zip'
...
Get-FileHash -Algorithm SHA256 -LiteralPath (Join-Path $workspace 'dist\AgentWorkbench-Setup-0.2.4-Windows-x64.exe') | Select-Object Path, Hash
